...
- **RF-5.18** (F4) Flechas **↑ / ↓** para subir y bajar de timeframe en el orden de la barra, conservando la posición. Dentro de un input o un select las flechas son del control
